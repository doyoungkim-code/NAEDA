...
-- 3-1) Face_Embeddings (naeda 얼굴 임베딩 저장)
...
CREATE TABLE store (
                         ...
                         category          VARCHAR(30)    NOT NULL,                -- SSAFY 카테고리 고유 ID (예: CG-4fa85f6425ad1d3)
                         category_name     VARCHAR(50),                            -- SSAFY 카테고리명 (예: 대형마트)
